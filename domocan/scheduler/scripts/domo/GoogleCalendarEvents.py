...
#       print daily_data_point.summary
	...
	timestartAtLeast = by_day.data[1].sunriseTime + timedelta(hours=1) #delta +2H en ete +1H en hiver
...
#Pas pendant vacances
	...
	timestartAtLeast = by_day.data[1].sunsetTime + timedelta(hours=1) #delta +1H en hiver +2H en ete
	timestart = time.strptime('%s'%timestartAtLeast, "%Y-%m-%d %H:%M:%S")
